...
% Grafica los datos de las caracterÃ­sticas de color y forma de la manzana y naranja
...
% Elementos de la grÃ¡fica 
title('ClasificaciÃ³n de frutas')
xlabel('Color')
ylabel('Forma')
legend('Manzanas rojas','Naranjas', 'Recta fd')
>>>>>>> f5fa74fe00fb9652806b5b4a0fb71fb949f1fdc0
axis([0.3 1 0.38 0.54])